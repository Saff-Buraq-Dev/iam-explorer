...
class TestGraphBuilder:
    ...
    def test_add_policy_attachments(self):
        ...
        self.builder._add_policy_attachments(
            self.sample_data['user_policies'],
            self.sample_data['role_policies'],
            self.sample_data['group_policies']
        )
    ...
    def test_load_graph(self):
        ...
        mock_graph.add_node('test', type='user')
    ...
    def test_handle_missing_data_gracefully(self):
        ...
        assert isinstance(graph, nx.DiGraph)
        assert len(graph.nodes) > 0  # Should have at least the user
